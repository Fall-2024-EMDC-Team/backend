...
urlpatterns = [
    ...
    path('mapping/userToRole/getUserByRole/<int:relatedid>/<int:roleType>/', get_user_by_role, name='get_user_by_role'),
    ...
    path('mapping/scoreSheet/getByTeamJudge/<int:sheetType>/<int:judge_id>/<int:team_id>/', score_sheet_by_judge_team, name='score_sheets_by_judge_team'),
    ...
    path('scoreSheet/edit/editField/', edit_score_sheet_field, name='edit_score_sheet_field')
